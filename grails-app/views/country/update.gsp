...
<div class="container-fluid">
    <h1 class="text-center my-4">Редактировать страну</h1>
        ...
        <g:form resource="${this.country}" method="POST" action="update">
            <fieldset>
                <div class="row p-2">
                    ...
                    <div class="col-2"><g:textField class="form-control" required="true" name="name"
                                                    value="${country.name}"/></div>
                </div>

                <div class="row p-2">
                    <div class="text-right col-6"><span>Столица</span></div>

                    <div class="col-2"><g:textField class="form-control" required="true" name="capital"
                                                    value="${country.capital}"/></div>
                </div>

                <div class="row">
                    <div class="col-6 text-right"><g:submitButton class="btn btn-primary ml-5" value="Обновить"
                                                                  name="update"/></div>
                </div>
            </fieldset>
        </g:form>
